                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="post-{{$post->id}}-dropdown"
                                    ...
                                    <form action="/dashboard/{{$post->slug}}" method="POST" class="py-1">
                                        @csrf
                                        @method('DELETE')
                                        <buttom type="submit"
                                           class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</buttom>
                                    </form>
                                </div>
                            </td>
                        </tr>
